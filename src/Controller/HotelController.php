...
{
    /**
     * @Route("/", name="user_hotels_index", methods={"GET"})
     */
    ...
    /**
     * @Route("/new", name="user_hotels_new", methods={"GET","POST"})
     */
    public function new(Request $request): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('user_hotels_index');
        }
    ...
    /**
     * @Route("/{id}", name="user_hotels_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{id}/edit", name="user_hotels_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{id}", name="user_hotels_delete", methods={"DELETE"})
     */
